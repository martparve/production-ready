...
There are seven categories worth worrying about.
...
**Context and skills supply chain attacks.** This is the new one. Dependencies are libraries your code calls. Skills are instructions your agent follows. And the skill ecosystem is far less mature than the package ecosystem in terms of security hygiene.
...
A trust boundary is a line in your system where the level of trust changes. On one side, you trust the actor. On the other side, you verify. In the AI code factory, there are four critical trust boundaries.
